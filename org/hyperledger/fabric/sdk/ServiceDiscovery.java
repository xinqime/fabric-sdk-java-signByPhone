...
public class ServiceDiscovery {
    ...
    static final EndorsementSelector ENDORSEMENT_SELECTION_LEAST_REQUIRED_BLOCKHEIGHT = sdChaindcode -> {
        ...
        for (SDLayout sdLayout : layouts) {
            ...
            Set<LGroup> remainingGroups = new HashSet<LGroup>();
            ...
            if (required.size() > 0) {
                Set<LGroup> remove = new HashSet<LGroup>(remainingGroups.size());
                for (LGroup lGroup : remainingGroups) {
            ...
            do {
                ...
                Set<LGroup> remove2 = new HashSet<LGroup>(remainingGroups.size());
                for (LGroup lGroup : remainingGroups) {
